...
import ReactSampleControl, {IReacSampleControlProps} from "./InternationalPhoneInputControl";

export class InternationalPhoneInputControlIndex implements ComponentFramework.StandardControl<IInputs, IOutputs> {
